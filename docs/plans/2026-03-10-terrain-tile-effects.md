...
```bash
cd /home/mathdaman/code/gmb-nuke-raider/.worktrees/terrain-effects
...
```python
#!/usr/bin/env python3
"""Generate the 6-tile Nuke Raider tileset PNG (48×8, RGB).
...
```
Expected: `build/nuke-raider.gb` produced, 0 errors (ignore "EVELYN" optimizer notice).
