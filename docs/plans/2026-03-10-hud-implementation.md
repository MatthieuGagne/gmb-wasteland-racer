...
```bash
cd /home/mathdaman/code/gmb-nuke-raider/.claude/worktrees/feat/hud
...
Expected: `build/nuke-raider.gb` produced with zero errors. Warnings about "so said EVELYN" are harmless and expected.
